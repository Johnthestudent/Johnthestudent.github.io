...
//If Erin is the chosen hero
if(localStorage.getItem("hero_name") == "Erin")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Erin.png");
    $("#characterweapon").attr("src", "Tools sources/Erin's sword.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Erin_Sword_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Sword attack " + " (" + parseInt(localStorage.getItem("Erin_Sword_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Leg strike " + " (" + parseInt(localStorage.getItem("Erin_Leg_strike")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Punch " + " (" + parseInt(localStorage.getItem("Erin_Punch")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Perfume (10 damage)";
    ...
    document.getElementById("specialattack4").innerHTML = "Whirling dervish (140 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Erin")
{
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Erin")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Sword_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Sword_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Sword_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Erin")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Leg_strike")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Leg_strike"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Leg_strike")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Erin")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Erin_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function specialattack4()
{
    if(localStorage.getItem("hero_name") == "Erin")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (140 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
