...
//If Emilia is the chosen hero
if(localStorage.getItem("hero_name") == "Emilia")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Emilia.png");
    $("#characterweapon").attr("src", "Tools sources/Emilia's dagger.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Emilia_Dagger_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Dagger attack" + " (" + parseInt(localStorage.getItem("Emilia_Dagger_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Jaguar leg" + " (" + parseInt(localStorage.getItem("Emilia_Jaguar_leg")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Dash " + " (" + parseInt(localStorage.getItem("Emilia_Dash")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Strings (200 damage)";
    document.getElementById("specialattack2").innerHTML = "Hunter's might (80 damage)";
    document.getElementById("specialattack3").innerHTML = "Venomous dagger (90 damage)";
    document.getElementById("specialattack4").innerHTML = "Tarzan yell (50 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Emilia")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Emilia.png");
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Emilia")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Dagger_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Dagger_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Dagger_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Emilia")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Jaguar_leg")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Jaguar_leg"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Jaguar_leg")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Emilia")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Dash")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Dash"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Emilia_Dash")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function specialattack2()
{
    if(localStorage.getItem("hero_name") == "Emilia")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (80 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
