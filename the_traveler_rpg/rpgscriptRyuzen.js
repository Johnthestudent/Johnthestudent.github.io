...
//If Ryuzen is the chosen hero
if(localStorage.getItem("hero_name") == "Ryuzen")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Ryuzen.png");
    $("#characterweapon").attr("src", "Tools sources/Ryuzen's samurai sword.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Ryuzen_Samurai_sword_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Samurai sword attack " + " (" + parseInt(localStorage.getItem("Ryuzen_Samurai_sword_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Punch " + " (" + parseInt(localStorage.getItem("Ryuzen_Punch")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Dash " + " (" + parseInt(localStorage.getItem("Ryuzen_Dash")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Whirling dervish (240 damage)";
    document.getElementById("specialattack2").innerHTML = "Electric slash (300 damage)";
    document.getElementById("specialattack3").innerHTML = "Samurai shout (30 damage)";
    document.getElementById("specialattack4").innerHTML = "Shuriken (90 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Ryuzen")
{
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Ryuzen")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Samurai_sword_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Samurai_sword_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Samurai_sword_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Ryuzen")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Ryuzen")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Dash")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Dash"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ryuzen_Dash")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function specialattack2()
{
    if(localStorage.getItem("hero_name") == "Ryuzen")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (240 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
...
function specialattack4()
{
    if(localStorage.getItem("hero_name") == "Ryuzen")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (90 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
                opponentscene_speed -= 60;
                document.getElementById("opponentspeed").innerHTML = opponentscene_speed;
