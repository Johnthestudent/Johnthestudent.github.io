...
//If Ian is the chosen hero
if(localStorage.getItem("hero_name") == "Ian")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Ian.png");
    $("#characterweapon").attr("src", "Tools sources/Ian's steel bo staff.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Ian_Staff_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Staff attack" + " (" + parseInt(localStorage.getItem("Ian_Staff_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Punch" + " (" + parseInt(localStorage.getItem("Ian_Punch")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Dash " + " (" + parseInt(localStorage.getItem("Ian_Dash")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Wind strike (100 damage)";
    document.getElementById("specialattack2").innerHTML = "Portalization (30 damage)";
    document.getElementById("specialattack3").innerHTML = "Magnetic strike (80 damage)";
    document.getElementById("specialattack4").innerHTML = "Plasma strike (200 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Ian")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Ian.png");
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Ian")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Staff_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Staff_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Staff_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Ian")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Ian")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Dash")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Dash"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Ian_Dash")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function specialattack4()
{
    if(localStorage.getItem("hero_name") == "Ian")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            if(battlescene_intelligence < 60)
            {
                alert("You don't have enough intelligence points to use this skill!");
            }
            else
        ...
        {
            if(battlescene_intelligence < 200)
            {
                alert("You don't have enough intelligence points to use this skill!");
            }
            else
