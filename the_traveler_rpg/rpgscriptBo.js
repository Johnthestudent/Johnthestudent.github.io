...
//If Bo is the chosen hero
if(localStorage.getItem("hero_name") == "Bo")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Bo.png");
    $("#characterweapon").attr("src", "Tools sources/Bo's crescent blade.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Bo_Crescent_blade_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Crescent blade attack " + " (" + parseInt(localStorage.getItem("Bo_Crescent_blade_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Leg strike " + " (" + parseInt(localStorage.getItem("Bo_Leg_strike")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Punch " + " (" + parseInt(localStorage.getItem("Bo_Punch")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Wind strike (30 damage)";
    document.getElementById("specialattack2").innerHTML = "Whirling dervish (200 damage)";
    document.getElementById("specialattack3").innerHTML = "Exploding card (300 damage)";
    document.getElementById("specialattack4").innerHTML = "Smoke bomb (10 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Bo")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Bo.png");
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Bo")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Crescent_blade_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Crescent_blade_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Crescent_blade_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Bo")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Leg_strike")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Leg_strike"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Leg_strike")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Bo")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Bo_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function specialattack2()
{
    if(localStorage.getItem("hero_name") == "Bo")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (400 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
...
function specialattack3()
{
    if(localStorage.getItem("hero_name") == "Bo")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (100 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
