...
//If Midna is the chosen hero
if(localStorage.getItem("hero_name") == "Midna")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Midna.png");
    $("#characterweapon").attr("src", "Tools sources/Midna's nunchucks.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Midna_Nunchaku_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Nunchaku attack " + " (" + parseInt(localStorage.getItem("Midna_Nunchaku_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Punch " + " (" + parseInt(localStorage.getItem("Midna_Punch")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Dash " + " (" + parseInt(localStorage.getItem("Midna_Dash")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Whirling dervish (200 damage)";
    document.getElementById("specialattack2").innerHTML = "Anime scream (40 damage)";
    document.getElementById("specialattack3").innerHTML = "Anime rage (300 damage)";
    document.getElementById("specialattack4").innerHTML = "Pepper spray (10 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Midna")
{
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Midna")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Nunchaku_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Nunchaku_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Nunchaku_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Midna")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Midna")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Dash")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Dash"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Midna_Dash")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function specialattack2()
{
    if(localStorage.getItem("hero_name") == "Midna")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (40 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
                opponentscene_speed -= 90;
                document.getElementById("opponentspeed").innerHTML = opponentscene_speed;
...
function specialattack3()
{
    if(localStorage.getItem("hero_name") == "Midna")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (300 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
...
function specialattack4()
{
    if(localStorage.getItem("hero_name") == "Midna")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (10 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
                opponentscene_defense -= 70;
                document.getElementById("opponentdefense").innerHTML = opponentscene_defense;
                opponentscene_attack -= 70;
                document.getElementById("opponentattack").innerHTML = opponentscene_attack;
                opponentscene_speed -= 70;
                document.getElementById("opponentspeed").innerHTML = opponentscene_speed;
                battlescene_intelligence -= 10;
                document.getElementById("rpgintelligence").innerHTML = battlescene_intelligence;
            }
