...
//If Daisuke is the chosen hero
if(localStorage.getItem("hero_name") == "Daisuke")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Daisuke.png");
    $("#characterweapon").attr("src", "Tools sources/Daisuke's samurai sword.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Daisuke_Katana_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Samurai sword attack " + " (" + parseInt(localStorage.getItem("Daisuke_Katana_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Punch " + " (" + parseInt(localStorage.getItem("Daisuke_Punch")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Dash " + " (" + parseInt(localStorage.getItem("Daisuke_Dash")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Plasma slash (280 damage)";
    document.getElementById("specialattack2").innerHTML = "Ninja strike (150 damage)";
    document.getElementById("specialattack3").innerHTML = "Shuriken (50 damage)";
    document.getElementById("specialattack4").innerHTML = "Whirling dervish (220 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Daisuke")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Bo.png");
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Daisuke")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Katana_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Katana_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Katana_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Daisuke")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Daisuke")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Dash")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Dash"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Daisuke_Dash")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function specialattack1()
{
    if(localStorage.getItem("hero_name") == "Daisuke")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            if(battlescene_intelligence < 50)
            {
                alert("You don't have enough intelligence points to use this skill!");
            }
            else
            {
                opponentscene_health -= (280 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
                opponentscene_defense -= 80;
                document.getElementById("opponentdefense").innerHTML = opponentscene_defense;
                battlescene_intelligence -= 50;
                document.getElementById("rpgintelligence").innerHTML = battlescene_intelligence;
            }
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
...
function specialattack2()
{
    if(localStorage.getItem("hero_name") == "Daisuke")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (150 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
                opponentscene_defense -= 30;
                document.getElementById("opponentdefense").innerHTML = opponentscene_defense;
                opponentscene_speed -= 80;
                document.getElementById("opponentspeed").innerHTML = opponentscene_speed;
...
function specialattack3()
{
    if(localStorage.getItem("hero_name") == "Daisuke")
    {
        ...
        {   
            ...
            {
                opponentscene_health -= (50 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
                opponentscene_speed -= 100;
                document.getElementById("opponentspeed").innerHTML = opponentscene_speed;
...
function specialattack4()
{
    if(localStorage.getItem("hero_name") == "Daisuke")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            if(battlescene_intelligence < 30)
            {
                alert("You don't have enough intelligence points to use this skill!");
            }
            else
            {
                opponentscene_health -= (220 + difference);
                document.getElementById("opponenthealth").innerHTML = opponentscene_health;
                opponentscene_defense -= 60;
                document.getElementById("opponentdefense").innerHTML = opponentscene_defense;
                battlescene_intelligence -= 30;
                document.getElementById("rpgintelligence").innerHTML = battlescene_intelligence;
            }
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
