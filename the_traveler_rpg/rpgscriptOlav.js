...
//If Olav is the chosen hero
if(localStorage.getItem("hero_name") == "Olav")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Olav.png");
    $("#characterweapon").attr("src", "Tools sources/Olav's axe.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Olav_Axe_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Axe attack " + " (" + parseInt(localStorage.getItem("Olav_Axe_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Punch " + " (" + parseInt(localStorage.getItem("Olav_Punch")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Dash " + " (" + parseInt(localStorage.getItem("Olav_Dash")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Metal noise (30 damage)";
    document.getElementById("specialattack2").innerHTML = "Boomerang strike (200 damage)";
    document.getElementById("specialattack3").innerHTML = "Big axe slash (300 damage)";
    document.getElementById("specialattack4").innerHTML = "Ale (10 damage)";
...
/*
else if(localStorage.getItem("hero_name") == "Olav")
{
    $("#playercharacter").attr("src", "Character sources/RPG_Hero_Olav.png");
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Olav")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Axe_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Axe_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Axe_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Olav")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Olav")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Dash")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Dash"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Olav_Dash")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
