...
if(localStorage.getItem("hero_name") == "Nate")
{
    ...
    $("#characterweapon").attr("src", "Tools sources/Nate's sword.png");
    document.getElementById("weaponstat").innerHTML = parseInt(localStorage.getItem("Nate_Sword_attack")) + " damage";

    document.getElementById("baseattack1").innerHTML = "Sword attack" + " (" + parseInt(localStorage.getItem("Nate_Sword_attack")) + " damage)";
    document.getElementById("baseattack2").innerHTML = "Punch" + " (" + parseInt(localStorage.getItem("Nate_Punch")) + " damage)";
    document.getElementById("baseattack3").innerHTML = "Dash " + " (" + parseInt(localStorage.getItem("Nate_Dash")) + " damage)";
    document.getElementById("specialattack1").innerHTML = "Fire slash (300 damage)";
    document.getElementById("specialattack2").innerHTML = "Whirling dervish (150 damage)";
    document.getElementById("specialattack3").innerHTML = "Boomerang strike (200 damage)";
    document.getElementById("specialattack4").innerHTML = "Light reflection (10 damage)";
...
function baseattack1()
{
    if(localStorage.getItem("hero_name") == "Nate")
    {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Sword_attack")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Sword_attack"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Sword_attack")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
...
{  
    if(localStorage.getItem("hero_name") == "Nate")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Punch")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Punch"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Punch")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
...
function baseattack3()
{
    if(localStorage.getItem("hero_name") == "Nate")
    {
        ...
        if(parseInt(localStorage.getItem("max_defense")) < battlescene_attack)
        {   
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Dash")) + difference;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_defense")) > battlescene_attack)
        {
        ...
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Dash"));
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        //Speed difference bonus
        if(parseInt(localStorage.getItem("max_speed")) < battlescene_speed)
        {
            opponentscene_health -= parseInt(localStorage.getItem("Nate_Dash")) + difference1;
            document.getElementById("opponenthealth").innerHTML = opponentscene_health;
        }
        else if(parseInt(localStorage.getItem("max_speed")) > battlescene_speed)
        {
