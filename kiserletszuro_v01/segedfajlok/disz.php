...
<div id="mainsection">
        <div id="filteredsections">
            <div class="card">
                <div class="card-body"><a class="card-link" href="fa.php">Fák
                    ...
                    $sql1 = "SELECT Noveny, Tipus, Evelo FROM plantak WHERE Noveny LIKE 'Diszfa01' OR Noveny LIKE 'Diszfa02'";
            ...
            <div class="card">
                ...
                if ($conn->connect_error) {
                  ...
                  echo mysqli_connect_error();
                    ...
                    //bokor section finds
                    //printing out the database itself onto the web page
                    $sql1 = "SELECT Noveny, Tipus, Evelo FROM plantak WHERE Noveny LIKE 'Gömbös'";
                    $result1 = $conn->query($sql1);
                    $talalat = 0; 
                    if ($result1->num_rows > 0) 
                    {
        ...
        <div id="utvonal">
          ...
          <a href="disz.php">Dísznövények</a>
        </div>
