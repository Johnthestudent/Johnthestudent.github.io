...
<div id="mainsection">
        <div id="filteredsections">
          <div class="card">
            <div class="card-body"><a class="card-link" href="hagymas.php">Hagymások
                <?php
                ...
                $sql1 = "SELECT Noveny, Tipus, Evelo FROM plantak WHERE Tipus='Hagymás'";
