...
<head>
    ...
    <title>Szeptemberben virágzó fa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptemberfa.php">Szeptemberben virágzó fa</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' and novenytipusa = 'fa'";
