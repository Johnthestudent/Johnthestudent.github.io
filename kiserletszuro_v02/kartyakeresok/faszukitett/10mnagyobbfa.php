...
<head>
    ...
    <title>10 m-től nagyobbra növő fa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="../fa.php">Fa</a> ->
          <a href="10mnagyobbfa.php">10 m-től nagyobbra növő fa</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '10 m-től nagyobbra növő' and novenytipusa = 'fa'";
