...
<head>
    ...
    <title>Örökzöld fa</title>
</head>
<body>
    <div id="filteredsections">
      <div class="card">
        <div class="card-body"><a class="card-link" href="sovenyfa.php">
          Sövénynek való
          <?php
      ...
      <div class="card">
        <div class="card-body"><a class="card-link" href="mediterranfa.php">
          Mediterrán
          <?php
    ...
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="../fa.php">Fa</a> ->
          <a href="orokzoldfa.php">Örökzöld fa</a>
        </div>
    <?php
          ...
          where kategoria like '%örökzöld' and novenytipusa = 'fa'";
