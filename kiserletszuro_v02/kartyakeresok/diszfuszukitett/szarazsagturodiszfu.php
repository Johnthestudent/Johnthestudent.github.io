...
<head>
    ...
    <title>Szárazságtűrő díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szarazsagturodiszfu.php">Szárazságtűrő díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'szárazságtűrő' and kategoria like '%díszfû¸ sziklakerti-¸ talajtakaró-¸ és egyéb évelõ növény'";
