...
<head>
    ...
    <title>Balkonnövény díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="balkonnovenydiszfu.php">Balkonnövény díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%balkonnövény' and kategoria like '%díszfû¸ sziklakerti-¸ talajtakaró-¸ és egyéb évelõ növény'";
