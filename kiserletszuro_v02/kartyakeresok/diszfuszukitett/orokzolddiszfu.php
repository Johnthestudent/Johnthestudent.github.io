...
<head>
    ...
    <title>Örökzöld díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</title>
</head>
<body>
    <div id="filteredsections">
        <div class="card">
            <div class="card-body"><a class="card-link" href="torpeorokzolddiszfu.php">
            Törpe örökzöld
            <?php
            require("torpeorokzoldszam.php");
            ?>
        </a></div>
        </div>
    </div>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="orokzolddiszfu.php">Örökzöld díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%örökzöld' and kategoria like '%díszfû¸ sziklakerti-¸ talajtakaró-¸ és egyéb évelõ növény'";
