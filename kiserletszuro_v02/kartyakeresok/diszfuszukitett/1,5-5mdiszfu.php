...
<head>
    ...
    <title>1,5-5 m-ig növő díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="1,5-5mdiszfu.php">1,5-5 m-ig növő díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '1,5-5 m-ig növő' and kategoria like '%díszfû¸ sziklakerti-¸ talajtakaró-¸ és egyéb évelõ növény'";
