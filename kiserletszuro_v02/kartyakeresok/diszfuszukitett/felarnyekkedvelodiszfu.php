...
<head>
    ...
    <title>Félárnyék kedvelő díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedvelodiszfu.php">Félárnyék kedvelő díszfű, sziklakerti-, talajtakaró-, és egyéb évelő növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and kategoria like '%díszfû¸ sziklakerti-¸ talajtakaró-¸ és egyéb évelõ növény'";
