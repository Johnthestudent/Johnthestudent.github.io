...
<head>
    ...
    <title>15-50 cm-ig növő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="15-50cmtorpeorokzold.php">15-50 cm-ig növő törpeörökzöld</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '15-50 cm-ig növő' and novenytipusa like '%törpe örökzöd'";
