...
<head>
    ...
    <title>Lila virágú törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="lilaviragtorpeorokzold.php">Lila virágú törpe örökzöld</a>
        </div>
    <?php
          ...
          where viragszine like '%lila' and novenytipusa like '%törpe örökzöd'";
