...
<head>
    ...
    <title>Félárnyék kedvelő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedvelotorpeorokzold.php">Félárnyék kedvelő törpeörökzöld</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and novenytipusa like '%törpe örökzöd'";
