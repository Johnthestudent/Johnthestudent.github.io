...
<head>
    ...
    <title>Júniusban virágzó törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juniustorpeorokzold.php">Júniusban virágzó törpe örökzöld</a>
        </div>
    <?php
          ...
          where viragzasideje like '%Június' and novenytipusa like '%törpe örökzöd'";
