...
<head>
    ...
    <title>Rózsaszín virágú törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="rozsaszinviragtorpeorokzold.php">Rózsaszín virágú törpe örökzöld</a>
        </div>
    <?php
          ...
          where viragszine like '%rózsaszín' and novenytipusa like '%törpe örökzöd'";
