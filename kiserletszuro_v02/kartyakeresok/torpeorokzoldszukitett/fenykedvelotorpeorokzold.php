...
<head>
    ...
    <title>Fénykedvelő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fenykedvelotorpeorokzold.php">Fénykedvelő törpeörökzöld</a>
        </div>
    <?php
          ...
          where fenyigenye = 'fénykedvelő' and novenytipusa like '%törpe örökzöd'";
