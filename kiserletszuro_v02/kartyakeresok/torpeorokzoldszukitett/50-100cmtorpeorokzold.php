...
<head>
    ...
    <title>50-100 cm-ig növő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="50-100cmtorpeorokzold.php">50-100 cm-ig növő törpeörökzöld</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '50-100 cm-ig növő' and novenytipusa like '%törpe örökzöd'";
