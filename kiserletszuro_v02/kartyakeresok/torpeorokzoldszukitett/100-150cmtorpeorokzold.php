...
<head>
    ...
    <title>100-150 cm-ig növő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="100-150cmtorpeorokzold.php">100-150 cm-ig növő törpeörökzöld</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '100-150 cm-ig növő' and novenytipusa like '%törpe örökzöd'";
