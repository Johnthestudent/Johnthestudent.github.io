...
<head>
    ...
    <title>0-15 cm-ig növő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="0-15cmtorpeorokzold.php">0-15 cm-ig növő törpeörökzöld</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '0-15 cm-ig növő' and novenytipusa like '%törpe örökzöd'";
