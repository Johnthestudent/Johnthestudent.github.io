...
<head>
    ...
    <title>Nem fagytűrő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="nemfagyturotorpeorokzold.php">Nem fagytűrő törpeörökzöld</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='nem fagytűrő' and novenytipusa like '%törpe örökzöd'";
