...
<head>
    ...
    <title>Közepesen vízigényes törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyestorpeorokzold.php">Közepesen vízigényes törpeörökzöld</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and novenytipusa like '%törpe örökzöd'";
