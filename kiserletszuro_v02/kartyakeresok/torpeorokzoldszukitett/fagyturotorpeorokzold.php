...
<head>
    ...
    <title>Fagytűrő törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fagyturotorpeorokzold.php">Fagytűrő törpeörökzöld</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='fagytűrő' and novenytipusa like '%törpe örökzöd'";
