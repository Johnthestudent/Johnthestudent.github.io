...
<head>
    ...
    <title>Augusztusban virágzó törpe örökzöld</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="augusztustorpeorokzold.php">Augusztusban virágzó törpe örökzöld</a>
        </div>
    <?php
          ...
          where viragzasideje like '%Augusztus' and novenytipusa like '%törpe örökzöd'";
