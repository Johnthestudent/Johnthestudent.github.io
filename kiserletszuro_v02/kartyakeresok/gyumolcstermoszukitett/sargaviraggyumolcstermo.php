...
<head>
    ...
    <title>Sárga virágú gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="sargaviraggyumolcstermo.php">Sárga virágú gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragszine like '%sárga' and kategoria like '%gyümölcstermő'";
