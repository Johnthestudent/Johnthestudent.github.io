...
<head>
    ...
    <title>Narancs virágú gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="narancsviraggyumolcstermo.php">Narancs virágú gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragszine like '%narancs' and kategoria like '%gyümölcstermő'";
