...
<head>
    ...
    <title>Fénykedvelő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fenykedvelogyumolcstermo.php">Fénykedvelő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'fénykedvelő' and kategoria like '%gyümölcstermő'";
