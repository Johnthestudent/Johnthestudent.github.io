...
<head>
    ...
    <title>10 m-től nagyobbra növő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="10mnagyobbgyumolcstermo.php">10 m-től nagyobbra növő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '10 m-től nagyobbra növő' and kategoria like '%gyümölcstermő'";
