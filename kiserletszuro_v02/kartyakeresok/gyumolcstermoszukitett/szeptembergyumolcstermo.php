...
<head>
    ...
    <title>Szeptemberben virágzó gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptembergyumolcstermo.php">Szeptemberben virágzó gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' and kategoria like '%gyümölcstermő'";
