...
<head>
    ...
    <title>Fehér virágú gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="feherviraggyumolcstermo.php">Fehér virágú gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragszine like '%fehér' and kategoria like '%gyümölcstermő'";
