...
<head>
    ...
    <title>Vízigényes gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="vizigenyesgyumolcstermo.php">Vízigényes gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'vízigényes' and kategoria like '%gyümölcstermő'";
