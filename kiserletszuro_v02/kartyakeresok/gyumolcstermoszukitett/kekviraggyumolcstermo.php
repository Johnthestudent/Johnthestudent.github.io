...
<head>
    ...
    <title>Kék virágú gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kekviraggyumolcstermo.php">Kék virágú gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragszine like '%kék' and kategoria like '%gyümölcstermő'";
