...
<head>
    ...
    <title>Közepesen vízigényes gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyesgyumolcstermo.php">Közepesen vízigényes gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and kategoria like '%gyümölcstermő'";
