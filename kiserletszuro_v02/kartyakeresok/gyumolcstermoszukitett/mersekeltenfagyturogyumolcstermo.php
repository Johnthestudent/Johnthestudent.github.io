...
<head>
    ...
    <title>Mérsékelten fagytűrő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="mersekeltenfagyturogyumolcstermo.php">Mérsékelten fagytűrő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='mérsékelten fagytűrő' and kategoria like '%gyümölcstermő'";
