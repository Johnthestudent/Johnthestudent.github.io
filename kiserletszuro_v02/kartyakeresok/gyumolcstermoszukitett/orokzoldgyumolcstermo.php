...
<head>
    ...
    <title>Örökzöld gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="orokzoldgyumolcstermo.php">Örökzöld gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%örökzöld' and kategoria like '%gyümölcstermő'";
