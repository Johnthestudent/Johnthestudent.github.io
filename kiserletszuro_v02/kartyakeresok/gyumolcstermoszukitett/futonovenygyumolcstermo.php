...
<head>
    ...
    <title>Gyümölcstermő futónövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="futonovenygyumolcstermo.php">Gyümölcstermő futónövény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%futónövény' and kategoria like '%gyümölcstermő'";
