...
<head>
    ...
    <title>Rózsaszín virágú gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="rozsaszinviraggyumolcstermo.php">Rózsaszín virágú gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragszine like '%rózsaszín' and kategoria like '%gyümölcstermő'";
