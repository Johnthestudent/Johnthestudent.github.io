...
<head>
    ...
    <title>5-10 m-ig növő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="5-10mgyumolcstermo.php">5-10 m-ig növő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '5-10 m-ig növő' and kategoria like '%gyümölcstermő'";
