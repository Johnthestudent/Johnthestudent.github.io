...
<head>
    ...
    <title>Zöld virágú gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="zoldviraggyumolcstermo.php">Zöld virágú gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragszine like '%zöld' and kategoria like '%gyümölcstermő'";
