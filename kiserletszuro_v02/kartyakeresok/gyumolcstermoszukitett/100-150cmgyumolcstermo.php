...
<head>
    ...
    <title>100-150 cm-ig növő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="100-150cmgyumolcstermo.php">100-150 cm-ig növő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '100-150 cm-ig növő' and kategoria like '%gyümölcstermő'";
