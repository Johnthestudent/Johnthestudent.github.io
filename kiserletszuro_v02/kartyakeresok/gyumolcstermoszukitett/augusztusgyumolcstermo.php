...
<head>
    ...
    <title>Augusztusban virágzó gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="augusztusgyumolcstermo.php">Augusztusban virágzó gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Augusztus' and kategoria like '%gyümölcstermő'";
