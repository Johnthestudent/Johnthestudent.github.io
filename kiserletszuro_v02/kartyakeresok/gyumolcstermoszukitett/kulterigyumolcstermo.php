...
<head>
    ...
    <title>Kültéri gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kulterigyumolcstermo.php">Kültéri gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where tipus = 'Kültéri növény' and kategoria like '%gyümölcstermő'";
