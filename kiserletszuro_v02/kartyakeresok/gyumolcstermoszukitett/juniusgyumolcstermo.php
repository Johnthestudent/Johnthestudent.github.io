...
<head>
    ...
    <title>Júniusban virágzó gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juniusgyumolcstermo.php">Júniusban virágzó gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Június' and kategoria like '%gyümölcstermő'";
