...
<head>
    ...
    <title>Félárnyék kedvelő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedvelogyumolcstermo.php">Félárnyék kedvelő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and kategoria like '%gyümölcstermő'";
