...
<head>
    ...
    <title>Májusban virágzó gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="majusgyumolcstermo.php">Májusban virágzó gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Május' and kategoria like '%gyümölcstermő'";
