...
<head>
    ...
    <title>Nem fagytűrő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="nemfagyturogyumolcstermo.php">Nem fagytűrő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='nem fagytűrő' and kategoria like '%gyümölcstermő'";
