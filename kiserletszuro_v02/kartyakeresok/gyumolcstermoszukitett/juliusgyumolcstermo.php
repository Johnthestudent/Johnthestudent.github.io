...
<head>
    ...
    <title>Júliusban virágzó gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juliusgyumolcstermo.php">Júliusban virágzó gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Július' and kategoria like '%gyümölcstermő'";
