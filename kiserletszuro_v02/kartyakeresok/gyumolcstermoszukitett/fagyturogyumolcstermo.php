...
<head>
    ...
    <title>Fagytűrő gyümölcstermő növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fagyturogyumolcstermo.php">Fagytűrő gyümölcstermő növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='fagytűrő' and kategoria like '%gyümölcstermő'";
