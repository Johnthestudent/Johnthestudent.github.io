...
<head>
    ...
    <title>Fehér virágú egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="feherviragegynyari.php">Fehér virágú egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where viragszine like '%fehér' and novenytipusa like '%balkonnövény'";
