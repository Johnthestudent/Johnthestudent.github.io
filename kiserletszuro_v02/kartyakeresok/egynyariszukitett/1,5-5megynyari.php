...
<head>
    ...
    <title>1,5-5 m-ig növő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="1,5-5megynyari.php">1,5-5 m-ig növő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '1,5-5 m-ig növő' and novenytipusa like '%balkonnövény'";
