...
<head>
    ...
    <title>Szeptemberben virágzó egynyári és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptemberegynyari.php">Szeptemberben virágzó egynyári és balkonnövény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' and novenytipusa like '%balkonnövény'";
