...
<head>
    ...
    <title>Nem fagytűrő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="nemfagyturoegynyari.php">Nem fagytűrő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='nem fagytűrő' and novenytipusa like '%balkonnövény'";
