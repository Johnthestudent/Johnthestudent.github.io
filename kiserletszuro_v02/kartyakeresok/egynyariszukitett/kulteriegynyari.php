...
<head>
    ...
    <title>Kültéri egynyári virágzó-, balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kulteriegynyari.php">Kültéri egynyári virágzó-, balkonnövény</a>
        </div>
    <?php
          ...
          where tipus = 'Kültéri növény' and novenytipusa like '%balkonnövény'";
