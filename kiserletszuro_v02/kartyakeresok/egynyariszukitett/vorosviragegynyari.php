...
<head>
    ...
    <title>Vörös virágú egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="vorosviragegynyari.php">Vörös virágú egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where viragszine like '%vörös' and novenytipusa like '%balkonnövény'";
