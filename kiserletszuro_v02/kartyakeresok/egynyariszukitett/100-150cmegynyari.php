...
<head>
    ...
    <title>100-150 cm-ig növő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="100-150cmegynyari.php">100-150 cm-ig növő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '100-150 cm-ig növő' and novenytipusa like '%balkonnövény'";
