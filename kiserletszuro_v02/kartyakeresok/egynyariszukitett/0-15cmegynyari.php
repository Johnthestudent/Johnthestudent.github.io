...
<head>
    ...
    <title>0-15 cm-ig növő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="0-15cmegynyari.php">0-15 cm-ig növő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '0-15 cm-ig növő' and novenytipusa like '%balkonnövény'";
