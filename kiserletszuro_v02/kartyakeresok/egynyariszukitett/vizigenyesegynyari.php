...
<head>
    ...
    <title>Vízigényes egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="vizigenyesegynyari.php">Vízigényes egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where vizigenye = 'vízigényes' and novenytipusa like '%balkonnövény'";
