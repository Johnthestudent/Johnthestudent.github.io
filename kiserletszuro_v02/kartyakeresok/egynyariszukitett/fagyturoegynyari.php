...
<head>
    ...
    <title>Fagytűrő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fagyturoegynyari.php">Fagytűrő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='fagytűrő' and novenytipusa like '%balkonnövény'";
