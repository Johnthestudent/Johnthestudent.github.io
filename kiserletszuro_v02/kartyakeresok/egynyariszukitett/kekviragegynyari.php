...
<head>
    ...
    <title>Kék virágú egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kekviragegynyari.php">Kék virágú egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where viragszine like '%kék' and novenytipusa like '%balkonnövény'";
