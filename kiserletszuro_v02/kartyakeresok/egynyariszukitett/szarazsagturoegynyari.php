...
<head>
    ...
    <title>Árnyéktűrő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="arnyekturoegynyari.php">Árnyéktűrő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where vizigenye = 'szárazságtűrő' and novenytipusa like '%balkonnövény'";
