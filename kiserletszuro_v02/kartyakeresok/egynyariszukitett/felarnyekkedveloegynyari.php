...
<head>
    ...
    <title>Félárnyék kedvelő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedveloegynyari.php">Félárnyék kedvelő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and novenytipusa like '%balkonnövény'";
