...
<head>
    ...
    <title>Lila virágú egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="lilaviragegynyari.php">Lila virágú egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where viragszine like '%lila' and novenytipusa like '%balkonnövény'";
