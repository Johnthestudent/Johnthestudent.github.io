...
<head>
    ...
    <title>50-100 cm-ig növő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="50-100cmegynyari.php">50-100 cm-ig növő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '50-100 cm-ig növő' and novenytipusa like '%balkonnövény'";
