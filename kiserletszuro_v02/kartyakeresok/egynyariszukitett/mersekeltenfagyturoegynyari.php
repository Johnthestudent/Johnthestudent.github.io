...
<head>
    ...
    <title>Mérsékelten fagytűrő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="mersekeltenfagyturoegynyari.php">Mérsékelten fagytűrő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='mérsékelten fagytűrő' and novenytipusa like '%balkonnövény'";
