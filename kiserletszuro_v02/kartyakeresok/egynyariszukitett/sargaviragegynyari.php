...
<head>
    ...
    <title>Sárga virágú egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="sargaviragegynyari.php">Sárga virágú egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where viragszine like '%sárga' and novenytipusa like '%balkonnövény'";
