...
<head>
    ...
    <title>15-50 cm-ig növő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="15-50cmegynyari.php">15-50 cm-ig növő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '15-50 cm-ig növő' and novenytipusa like '%balkonnövény'";
