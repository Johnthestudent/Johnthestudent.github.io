...
<head>
    ...
    <title>Narancs virágú egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="narancsviragegynyari.php">Narancs virágú egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where viragszine like '%narancs' and novenytipusa like '%balkonnövény'";
