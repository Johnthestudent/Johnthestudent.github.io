...
<head>
    ...
    <title>Júliusban virágzó egynyári és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juliusegynyari.php">Júliusban virágzó egynyári és balkonnövény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Július' and novenytipusa like '%balkonnövény'";
