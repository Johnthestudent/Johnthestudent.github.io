...
<head>
    ...
    <title>Közepesen vízigényes egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyesegynyari.php">Közepesen vízigényes egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and novenytipusa like '%balkonnövény'";
