...
<head>
    ...
    <title>Rózsaszín virágú egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="rozsaszinviragegynyari.php">Rózsaszín virágú egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where viragszine like '%rózsaszín' and novenytipusa like '%balkonnövény'";
