...
<head>
    ...
    <title>Augusztusban virágzó egynyári és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="augusztusegynyari.php">Augusztusban virágzó egynyári és balkonnövény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Augusztus' and novenytipusa like '%balkonnövény'";
