...
<head>
    ...
    <title>Fénykedvelő egynyári virágzó-, és balkonnövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fenykedveloegynyari.php">Fénykedvelő egynyári virágzó-, és balkonnövény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'fénykedvelő' and novenytipusa like '%balkonnövény'";
