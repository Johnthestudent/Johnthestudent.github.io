...
<head>
    ...
    <title>1,5-5 m-ig növő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="1,5-5mcserje.php">1,5-5 m-ig növő cserje</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '1,5-5 m-ig növő' and novenytipusa like '%cserje'";
