...
<head>
    ...
    <title>Mérsékelten fagytűrő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="mersekeltenfagyturocserje.php">Mérsékelten fagytűrő cserje</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='mérsékelten fagytűrő' and novenytipusa like '%cserje'";
