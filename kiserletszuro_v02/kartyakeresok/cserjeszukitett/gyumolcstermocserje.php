...
<head>
    ...
    <title>Gyümölcstermő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="gyumolcstermocserje.php">Gyümölcstermő cserje</a>
        </div>
    <?php
          ...
          where kategoria like '%lombhullató fa-¸ cserje; gyümölcstermõ' and novenytipusa like '%fa; cserje'";
