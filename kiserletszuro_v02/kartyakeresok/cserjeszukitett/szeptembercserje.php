...
<head>
    ...
    <title>Szeptemberben virágzó cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptembercserje.php">Szeptemberben virágzó cserje</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' 
          and novenytipusa like '%cserje'";
