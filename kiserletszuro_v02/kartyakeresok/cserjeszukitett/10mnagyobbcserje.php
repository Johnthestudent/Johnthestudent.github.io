...
<head>
    ...
    <title>10 m-től nagyobbra növő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="10mnagyobbcserje.php">10 m-től nagyobbra növő cserje</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '10 m-től nagyobbra növő' and novenytipusa like '%cserje'";
