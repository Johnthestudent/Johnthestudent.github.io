...
<head>
    ...
    <title>0-15 cm-ig növő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="0-15cmcserje.php">0-15 cm-ig növő cserje</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '0-15 cm-ig növő' and novenytipusa like '%cserje'";
