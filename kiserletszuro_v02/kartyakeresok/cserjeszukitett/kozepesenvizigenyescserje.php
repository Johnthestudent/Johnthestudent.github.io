...
<head>
    ...
    <title>Közepesen vízigényes cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyescserje.php">Közepesen vízigényes cserje</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and novenytipusa like '%cserje'";
