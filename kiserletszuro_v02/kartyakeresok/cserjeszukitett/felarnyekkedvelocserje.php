...
<head>
    ...
    <title>Félárnyék kedvelő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedvelocserje.php">Félárnyék kedvelő cserje</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and novenytipusa like '%cserje'";
