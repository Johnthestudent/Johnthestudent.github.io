...
<head>
    ...
    <title>100-150 cm-ig növő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="100-150cmcserje.php">100-150 cm-ig növő cserje</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '100-150 cm-ig növő' and novenytipusa like '%cserje'";
