...
<head>
    ...
    <title>5-10 m-ig növő cserje</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="5-10mcserje.php">5-10 m-ig növő cserje</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '5-10 m-ig növő' and novenytipusa like '%cserje'";
