...
<head>
    ...
    <title>Cserje sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="cserjesoveny.php">Cserje sövénynek való növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%cserje' and kategoria like '%sövénynek való'";
