...
<head>
    ...
    <title>Közepesen vízigényes sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyessoveny.php">Közepesen vízigényes sövénynek való növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and kategoria like '%sövénynek való'";
