...
<head>
    ...
    <title>Májusban virágzó sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="majussoveny.php">Májusban virágzó sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Május' and kategoria like '%sövénynek való'";
