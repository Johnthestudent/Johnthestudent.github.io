...
<head>
    ...
    <title>Júniusban virágzó sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juniussoveny.php">Júniusban virágzó sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Június' and kategoria like '%sövénynek való'";
