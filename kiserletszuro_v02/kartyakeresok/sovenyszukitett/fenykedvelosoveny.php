...
<head>
    ...
    <title>Fénykedvelő sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fenykedvelosoveny.php">Fénykedvelő sövénynek való növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'fénykedvelő' and kategoria like '%sövénynek való'";
