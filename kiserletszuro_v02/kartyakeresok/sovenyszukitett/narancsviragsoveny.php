...
<head>
    ...
    <title>Narancs virágú sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="narancsviragsoveny.php">Narancs virágú sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragszine like '%narancs' and kategoria like '%sövénynek való'";
