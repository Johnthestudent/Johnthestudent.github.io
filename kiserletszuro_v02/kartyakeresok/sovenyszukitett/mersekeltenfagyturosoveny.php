...
<head>
    ...
    <title>Mérsékelten fagytűrő sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="mersekeltenfagyturosoveny.php">Mérsékelten fagytűrő sövénynek való növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='mérsékelten fagytűrő' and kategoria like '%sövénynek való'";
