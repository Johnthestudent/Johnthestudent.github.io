...
<head>
    ...
    <title>Vörös virágú sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="vorosviragsoveny.php">Vörös virágú sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragszine like '%vörös' and kategoria like '%sövénynek való'";
