...
<head>
    ...
    <title>Áprilisban virágzó sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="aprilissoveny.php">Áprilisban virágzó sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Április' and kategoria like '%sövénynek való'";
