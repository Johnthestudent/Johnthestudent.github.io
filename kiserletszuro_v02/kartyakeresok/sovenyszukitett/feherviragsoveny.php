...
<head>
    ...
    <title>Fehér virágú sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="feherviragsoveny.php">Fehér virágú sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragszine like '%fehér' and kategoria like '%sövénynek való'";
