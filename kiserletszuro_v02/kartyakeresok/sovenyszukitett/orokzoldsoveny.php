...
<head>
    ...
    <title>Örökzöld sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="orokzoldsoveny.php">Örökzöld sövénynek való növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%örökzöld' and kategoria like '%sövénynek való'";
