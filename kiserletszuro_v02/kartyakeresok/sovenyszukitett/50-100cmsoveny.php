...
<head>
    ...
    <title>50-100 cm-ig növő sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="50-100cmsoveny.php">50-100 cm-ig növő sövénynek való növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '50-100 cm-ig növő' and kategoria like '%sövénynek való'";
