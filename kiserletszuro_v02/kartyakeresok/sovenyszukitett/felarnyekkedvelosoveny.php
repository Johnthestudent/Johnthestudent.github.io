...
<head>
    ...
    <title>Félárnyék kedvelő sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedvelosoveny.php">Félárnyék kedvelő sövénynek való növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and kategoria like '%sövénynek való'";
