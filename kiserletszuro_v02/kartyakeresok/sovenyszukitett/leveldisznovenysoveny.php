...
<head>
    ...
    <title>Levéldísznövény sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="leveldisznovenysoveny.php">Levéldísznövény sövénynek való növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%levéldísznövény' and kategoria like '%sövénynek való'";
