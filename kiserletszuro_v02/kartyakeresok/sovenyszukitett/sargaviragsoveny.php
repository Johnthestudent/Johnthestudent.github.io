...
<head>
    ...
    <title>Sárga virágú sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="sargaviragsoveny.php">Sárga virágú sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragszine like '%sárga' and kategoria like '%sövénynek való'";
