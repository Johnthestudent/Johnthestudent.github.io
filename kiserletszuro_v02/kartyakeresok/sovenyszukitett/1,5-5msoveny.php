...
<head>
    ...
    <title>1,5-5 m-ig növő sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="1,5-5msoveny.php">1,5-5 m-ig növő sövénynek való növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '1,5-5 m-ig növő' and kategoria like '%sövénynek való'";
