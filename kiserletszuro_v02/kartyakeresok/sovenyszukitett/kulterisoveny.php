...
<head>
    ...
    <title>Kültéri sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kulterisoveny.php">Kültéri sövénynek való növény</a>
        </div>
    <?php
          ...
          where tipus = 'Kültéri növény' and kategoria like '%sövénynek való'";
