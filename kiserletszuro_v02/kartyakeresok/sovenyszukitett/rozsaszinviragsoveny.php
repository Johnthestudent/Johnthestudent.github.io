...
<head>
    ...
    <title>Rózsaszín virágú sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="rozsaszinviragsoveny.php">Rózsaszín virágú sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragszine like '%rózsaszín' and kategoria like '%sövénynek való'";
