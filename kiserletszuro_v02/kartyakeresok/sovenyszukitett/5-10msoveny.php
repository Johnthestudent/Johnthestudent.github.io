...
<head>
    ...
    <title>5-10 m-ig növő sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="5-10msoveny.php">5-10 m-ig növő sövénynek való növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '5-10 m-ig növő' and kategoria like '%sövénynek való'";
