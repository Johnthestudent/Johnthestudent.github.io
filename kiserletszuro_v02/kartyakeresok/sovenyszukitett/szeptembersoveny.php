...
<head>
    ...
    <title>Szeptemberben virágzó sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptembersoveny.php">Szeptemberben virágzó sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' and kategoria like '%sövénynek való'";
