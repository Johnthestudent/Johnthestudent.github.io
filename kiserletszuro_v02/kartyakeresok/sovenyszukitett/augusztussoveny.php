...
<head>
    ...
    <title>Augusztusban virágzó sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="augusztussoveny.php">Augusztusban virágzó sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Augusztus' and kategoria like '%sövénynek való'";
