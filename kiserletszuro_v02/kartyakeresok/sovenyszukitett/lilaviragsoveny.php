...
<head>
    ...
    <title>Lila virágú sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="lilaviragsoveny.php">Lila virágú sövénynek való növény</a>
        </div>
    <?php
          ...
          where viragszine like '%lila' and kategoria like '%sövénynek való'";
