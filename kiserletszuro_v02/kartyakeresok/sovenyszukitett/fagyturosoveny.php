...
<head>
    ...
    <title>Fagytűrő sövénynek való növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fagyturosoveny.php">Fagytűrő sövénynek való növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='fagytűrő' and kategoria like '%sövénynek való'";
