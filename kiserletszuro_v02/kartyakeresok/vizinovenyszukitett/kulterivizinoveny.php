...
<head>
    ...
    <title>Kültéri vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          <a href="../../index.php">Főoldal </a> ->
          <a href="../vizinoveny.php">Gyümölcstermő növény</a> ->
          <a href="kulterivizinoveny.php">Kültéri vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where tipus = 'Kültéri növény' and kategoria like '%vízparti növény'";
