...
<head>
    ...
    <title>15-50 cm-ig növő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="15-50cmvizinoveny.php">15-50 cm-ig növő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '15-50 cm-ig növő' and kategoria like '%vízparti növény'";
