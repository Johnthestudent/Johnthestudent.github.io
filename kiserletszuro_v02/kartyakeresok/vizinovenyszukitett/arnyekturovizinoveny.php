...
<head>
    ...
    <title>Árnyéktűrő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="arnyekturovizinoveny.php">Árnyéktűrő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'árnyéktűrő' and kategoria like '%vízparti növény'";
