...
<head>
    ...
    <title>Közepesen vízigényes vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyesvizinoveny.php">Közepesen vízigényes vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and kategoria like '%vízparti növény'";
