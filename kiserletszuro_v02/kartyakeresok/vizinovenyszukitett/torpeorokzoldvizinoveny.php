...
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="torpeorokzoldvizinoveny.php">Törpe örökzöld vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%törpe örökzöd; örökzöld; vízparti növény; levéldísznövény' and kategoria like '%vízparti növény'";
