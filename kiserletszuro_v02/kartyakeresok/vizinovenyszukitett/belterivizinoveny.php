...
<head>
    ...
    <title>Beltéri vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="belterivizinoveny.php">Beltéri vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where tipus = 'Beltéri növény' and kategoria like '%vízparti növény'";
