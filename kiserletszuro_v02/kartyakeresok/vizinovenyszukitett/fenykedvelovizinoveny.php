...
<head>
    ...
    <title>Fénykedvelő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fenykedvelovizinoveny.php">Fénykedvelő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'fénykedvelő' and kategoria like '%vízparti növény'";
