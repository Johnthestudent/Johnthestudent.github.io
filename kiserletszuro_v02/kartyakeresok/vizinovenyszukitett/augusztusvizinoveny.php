...
<head>
    ...
    <title>Augusztusban virágzó vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="augusztusvizinoveny.php">Augusztusban virágzó vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Augusztus' and kategoria like '%vízparti növény'";
