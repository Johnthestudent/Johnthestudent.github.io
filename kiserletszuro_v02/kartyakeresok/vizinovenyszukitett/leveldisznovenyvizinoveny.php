...
<head>
    ...
    <title>Levéldísznövény vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="leveldisznovenyvizinoveny.php">Levéldísznövény vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%levéldísznövény' and kategoria like '%vízparti növény'";
