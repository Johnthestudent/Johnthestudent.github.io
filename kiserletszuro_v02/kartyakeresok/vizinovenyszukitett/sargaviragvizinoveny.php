...
<head>
    ...
    <title>Sárga virágú vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="sargaviragvizinoveny.php">Sárga virágú vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where viragszine like '%sárga' and kategoria like '%vízparti növény'";
