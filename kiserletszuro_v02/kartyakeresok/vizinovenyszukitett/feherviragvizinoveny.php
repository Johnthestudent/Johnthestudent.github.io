...
<head>
    ...
    <title>Fehér virágú vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="feherviragvizinoveny.php">Fehér virágú vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where viragszine like '%fehér' and kategoria like '%vízparti növény'";
