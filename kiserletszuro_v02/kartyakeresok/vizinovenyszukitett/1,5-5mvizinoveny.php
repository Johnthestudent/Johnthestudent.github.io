...
<head>
    ...
    <title>1,5-5 m-ig növő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="1,5-5mvizinoveny.php">1,5-5 m-ig növő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '1,5-5 m-ig növő' and kategoria like '%vízparti növény'";
