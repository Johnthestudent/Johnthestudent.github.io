...
<head>
    ...
    <title>Kék virágú vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kekviragvizinoveny.php">Kék virágú vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where viragszine like '%kék' and kategoria like '%vízparti növény'";
