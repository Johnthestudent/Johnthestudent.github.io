...
<head>
    ...
    <title>Nem fagytűrő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="nemfagyturovizinoveny.php">Nem fagytűrő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='nem fagytűrő' and kategoria like '%vízparti növény'";
