...
<head>
    ...
    <title>50-100 cm-ig növő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="50-100cmvizinoveny.php">50-100 cm-ig növő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '50-100 cm-ig növő' and kategoria like '%vízparti növény'";
