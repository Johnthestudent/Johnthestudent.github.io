...
<head>
    ...
    <title>Rózsaszín virágú vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="rozsaszinviragvizinoveny.php">Rózsaszín virágú vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where viragszine like '%rózsaszín' and kategoria like '%vízparti növény'";
