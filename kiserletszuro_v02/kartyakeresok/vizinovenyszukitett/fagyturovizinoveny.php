...
<head>
    ...
    <title>Fagytűrő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fagyturovizinoveny.php">Fagytűrő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='fagytűrő' and kategoria like '%vízparti növény'";
