...
<head>
    ...
    <title>Májusban virágzó vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="majusvizinoveny.php">Májusban virágzó vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Május' and kategoria like '%vízparti növény'";
