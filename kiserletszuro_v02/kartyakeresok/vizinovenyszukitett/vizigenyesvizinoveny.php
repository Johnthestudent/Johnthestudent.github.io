...
<head>
    ...
    <title>Vízigényes vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="vizigenyesvizinoveny.php">Vízigényes vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'vízigényes' and kategoria like '%vízparti növény'";
