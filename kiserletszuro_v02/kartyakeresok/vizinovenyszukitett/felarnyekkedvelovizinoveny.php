...
<head>
    ...
    <title>Félárnyék kedvelő vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedvelovizinoveny.php">Félárnyék kedvelő vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and kategoria like '%vízparti növény'";
