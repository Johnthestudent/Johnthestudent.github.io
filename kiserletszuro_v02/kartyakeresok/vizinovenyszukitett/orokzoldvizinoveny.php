...
<head>
    ...
    <title>Örökzöld vízi-, vízparti növény</title>
</head>
<body>
    <div id="filteredsections">
        <div class="card">
            <div class="card-body"><a class="card-link" href="torpeorokzoldvizinoveny.php">
            Törpe örökzöld
            <?php
    ...
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="orokzoldvizinoveny.php">Örökzöld vízi-, vízparti növény</a> ->
        </div>
    <?php
          ...
          where novenytipusa like '%örökzöld; vízparti növény; levéldísznövény' and kategoria like '%vízparti növény'";
