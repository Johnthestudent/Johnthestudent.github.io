...
<head>
    ...
    <title>Szeptemberben virágzó vízi-, vízparti növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptembervizinoveny.php">Szeptemberben virágzó vízi-, vízparti növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' and kategoria like '%vízparti növény'";
