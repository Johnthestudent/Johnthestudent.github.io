...
<head>
    ...
    <title>100-150 cm-ig növő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="100-150cmviragzo.php">100-150 cm-ig növő virágzó</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '100-150 cm-ig növő' and kategoria like '%virágzó'";
