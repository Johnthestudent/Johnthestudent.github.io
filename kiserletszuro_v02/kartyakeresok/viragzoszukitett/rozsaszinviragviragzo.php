...
<head>
    ...
    <title>Rózsaszín virágú virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="rozsaszinviragviragzo.php">Rózsaszín virágú virágzó</a>
        </div>
    <?php
          ...
          where viragszine like '%rózsaszín' and kategoria like '%virágzó'";
