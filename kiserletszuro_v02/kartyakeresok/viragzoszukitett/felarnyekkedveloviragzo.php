...
<head>
    ...
    <title>Félárnyék kedvelő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedveloviragzo.php">Félárnyék kedvelő virágzó</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and kategoria like '%virágzó'";
