...
<head>
    ...
    <title>Egyéb kerti virág virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="egyebkertiviragviragzo.php">Egyéb kerti virág virágzó</a>
        </div>
    <?php
          ...
          where novenytipusa like '%egyéb kerti virág' and kategoria like '%virágzó'";
