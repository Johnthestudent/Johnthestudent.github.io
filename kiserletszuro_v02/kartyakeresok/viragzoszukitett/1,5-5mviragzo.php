...
<head>
    ...
    <title>1,5-5 m-ig növő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="1,5-5mviragzo.php">1,5-5 m-ig növő virágzó</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '1,5-5 m-ig növő' and kategoria like '%virágzó'";
