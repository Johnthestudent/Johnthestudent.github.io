...
<head>
    ...
    <title>0-15 cm-ig növő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="0-15cmviragzo.php">0-15 cm-ig növő virágzó</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '0-15 cm-ig növő' and kategoria like '%virágzó'";
