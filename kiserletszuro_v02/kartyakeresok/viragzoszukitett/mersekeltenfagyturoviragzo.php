...
<head>
    ...
    <title>Mérsékelten fagytűrő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="mersekeltenfagyturoviragzo.php">Mérsékelten fagytűrő virágzó</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='mérsékelten fagytűrő' and kategoria like '%virágzó'";
