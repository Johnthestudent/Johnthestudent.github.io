...
<head>
    ...
    <title>Novemberben virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="novemberviragzo.php">Novemberben virágzó</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%November' and kategoria like '%virágzó'";
