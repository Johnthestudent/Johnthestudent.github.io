...
<head>
    ...
    <title>Márciusban virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="marciusviragzo.php">Márciusban virágzó</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Március' and kategoria like '%virágzó'";
