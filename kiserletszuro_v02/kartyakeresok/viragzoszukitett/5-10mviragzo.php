...
<head>
    ...
    <title>5-10 m-ig növő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="5-10mviragzo.php">5-10 m-ig növő virágzó</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '5-10 m-ig növő' and kategoria like '%virágzó'";
