...
<head>
    ...
    <title>Szeptemberben virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptemberviragzo.php">Szeptemberben virágzó</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' and kategoria like '%virágzó'";
