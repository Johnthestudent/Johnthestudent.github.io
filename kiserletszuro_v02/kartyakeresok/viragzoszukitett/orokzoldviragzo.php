...
<head>
    ...
    <title>Örökzöld virágzó</title>
</head>
<body>
    <div id="filteredsections">
        <div class="card">
            <div class="card-body"><a class="card-link" href="torpeorokzoldviragzo.php">
            Törpe örökzöld
            <?php
    ...
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="orokzoldviragzo.php">Örökzöld virágzó</a>
        </div>
    <?php
          ...
          where novenytipusa like '%örökzöld' and kategoria like '%virágzó'";
