...
<head>
    ...
    <title>Törpe örökzöld virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="torpeorokzoldviragzo.php">Törpe örökzöld virágzó</a>
        </div>
    <?php
          ...
          where novenytipusa like '%törpe örökzöd' and kategoria like '%virágzó'";
