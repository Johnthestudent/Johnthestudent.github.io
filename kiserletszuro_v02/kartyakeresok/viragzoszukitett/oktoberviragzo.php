...
<head>
    ...
    <title>Októberben virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="oktoberviragzo.php">Októberben virágzó</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Október' and kategoria like '%virágzó'";
