...
<head>
    ...
    <title>Közepesen vízigényes virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyesviragzo.php">Közepesen vízigényes virágzó</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and kategoria like '%virágzó'";
