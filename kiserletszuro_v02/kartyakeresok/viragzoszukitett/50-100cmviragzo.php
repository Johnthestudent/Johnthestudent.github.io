...
<head>
    ...
    <title>50-100 cm-ig növő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="50-100cmviragzo.php">50-100 cm-ig növő virágzó</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '50-100 cm-ig növő' and kategoria like '%virágzó'";
