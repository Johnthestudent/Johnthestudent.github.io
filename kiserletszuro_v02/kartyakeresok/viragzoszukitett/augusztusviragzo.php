...
<head>
    ...
    <title>Augusztusban virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="augusztusviragzo.php">Augusztusban virágzó</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Augusztus' and kategoria like '%virágzó'";
