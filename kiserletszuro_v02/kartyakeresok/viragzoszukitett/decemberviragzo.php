...
<head>
    ...
    <title>Decemberben virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="decemberviragzo.php">Decemberben virágzó</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%December' and kategoria like '%virágzó'";
