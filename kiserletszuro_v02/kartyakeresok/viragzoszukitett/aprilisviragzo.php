...
<head>
    ...
    <title>Áprilisban virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="aprilisviragzo.php">Áprilisban virágzó</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Április' and kategoria like '%virágzó'";
