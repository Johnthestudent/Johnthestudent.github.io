...
<head>
    ...
    <title>15-50 cm-ig növő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="15-50cmviragzo.php">15-50 cm-ig növő virágzó</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '15-50 cm-ig növő' and kategoria like '%virágzó'";
