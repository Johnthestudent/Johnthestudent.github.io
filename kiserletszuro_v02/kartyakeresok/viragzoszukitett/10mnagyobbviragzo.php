...
<head>
    ...
    <title>10 m-től nagyobbra növő virágzó</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="10mnagyobbviragzo.php">10 m-től nagyobbra növő virágzó</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '10 m-től nagyobbra növő' and kategoria like '%virágzó'";
