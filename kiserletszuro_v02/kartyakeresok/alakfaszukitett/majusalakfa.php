...
<head>
    ...
    <title>Májusban virágzó alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="majusalakfa.php">Májusban virágzó alakfa</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Május' and kategoria like '%alakfa'";
