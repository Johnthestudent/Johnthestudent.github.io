...
<head>
    ...
    <title>Levéldísznövény alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="leveldisznovenyalakfa.php">Levéldísznövény alakfa</a>
        </div>
    <?php
          ...
          where novenytipusa like '%levéldísznövény' and kategoria like '%alakfa'";
