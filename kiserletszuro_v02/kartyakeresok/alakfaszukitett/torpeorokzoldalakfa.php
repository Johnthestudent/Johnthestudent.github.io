...
<head>
    ...
    <title>Törpe örökzöld alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="torpeorokzoldalakfa.php">Törpe örökzöld alakfa</a>
        </div>
    <?php
          ...
          where novenytipusa like '%törpe örökzöd' and kategoria like '%alakfa'";
