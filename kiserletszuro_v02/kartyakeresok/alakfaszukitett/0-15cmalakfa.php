...
<head>
    ...
    <title>0-15 cm-ig növő alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="0-15cmalakfa.php">0-15 cm-ig növő alakfa</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '0-15 cm-ig növő' and kategoria like '%alakfa'";
