...
<head>
    ...
    <title>50-100 cm-ig növő alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="50-100cmalakfa.php">50-100 cm-ig növő alakfa</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '50-100 cm-ig növő' and kategoria like '%alakfa'";
