...
<head>
    ...
    <title>Áprilisban virágzó alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="aprilisalakfa.php">Áprilisban virágzó alakfa</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Április' and kategoria like '%alakfa'";
