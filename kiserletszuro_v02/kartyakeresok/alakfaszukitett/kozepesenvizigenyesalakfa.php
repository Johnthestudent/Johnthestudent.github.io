...
<head>
    ...
    <title>Közepesen vízigényes alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyesalakfa.php">Közepesen vízigényes alakfa</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and kategoria like '%alakfa'";
