...
<head>
    ...
    <title>Júniusban virágzó alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juniusalakfa.php">Júniusban virágzó alakfa</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Június' and kategoria like '%alakfa'";
