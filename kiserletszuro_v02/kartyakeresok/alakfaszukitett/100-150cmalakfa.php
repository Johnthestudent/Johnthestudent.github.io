...
<head>
    ...
    <title>100-150 cm-ig növő alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="100-150cmalakfa.php">100-150 cm-ig növő alakfa</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '100-150 cm-ig növő' and kategoria like '%alakfa'";
