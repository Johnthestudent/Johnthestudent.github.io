...
<head>
    ...
    <title>Örökzöld alakfa</title>
</head>
<body>
    <div id="filteredsections">
        <div class="card">
            <div class="card-body"><a class="card-link" href="torpeorokzoldalakfa.php">
            Törpe örökzöld
            <?php
    ...
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="orokzoldalakfa.php">Örökzöld alakfa</a>
        </div>
    <?php
          ...
          where novenytipusa like '%örökzöld' and kategoria like '%alakfa'";
