...
<head>
    ...
    <title>Júliusban virágzó alakfa</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juliusalakfa.php">Júliusban virágzó alakfa</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Július' and kategoria like '%alakfa'";
