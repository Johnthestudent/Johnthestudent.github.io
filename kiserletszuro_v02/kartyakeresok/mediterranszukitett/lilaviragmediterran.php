...
<head>
    ...
    <title>Lila virágú mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="lilaviragmediterran.php">Lila virágú mediterrán növény</a>
        </div>
    <?php
          ...
          where viragszine like '%lila' and kategoria like '%dézsás növény'";
