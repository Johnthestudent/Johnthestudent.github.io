...
<head>
    ...
    <title>Szárazságtűrő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szarazsagturomediterran.php">Szárazságtűrő mediterrán növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'szárazságtűrő' and kategoria like '%dézsás növény'";
