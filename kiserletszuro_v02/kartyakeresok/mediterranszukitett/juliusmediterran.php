...
<head>
    ...
    <title>Júliusban virágzó mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juliusmediterran.php">Júliusban virágzó mediterrán növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Július' and kategoria like '%dézsás növény'";
