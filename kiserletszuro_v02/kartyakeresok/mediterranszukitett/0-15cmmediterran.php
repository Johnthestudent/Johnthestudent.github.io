...
<head>
    ...
    <title>0-15 cm-ig növő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="0-15cmmediterran.php">0-15 cm-ig növő mediterrán növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '0-15 cm-ig növő' and kategoria like '%dézsás növény'";
