...
<head>
    ...
    <title>Sárga virágú mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="sargaviragmediterran.php">Sárga virágú mediterrán növény</a>
        </div>
    <?php
          ...
          where viragszine like '%sárga' and kategoria like '%dézsás növény'";
