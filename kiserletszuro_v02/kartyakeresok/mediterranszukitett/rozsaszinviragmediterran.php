...
<head>
    ...
    <title>Rózsaszín virágú mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="rozsaszinviragmediterran.php">Rózsaszín virágú mediterrán növény</a>
        </div>
    <?php
          ...
          where viragszine like '%rózsaszín' and kategoria like '%dézsás növény'";
