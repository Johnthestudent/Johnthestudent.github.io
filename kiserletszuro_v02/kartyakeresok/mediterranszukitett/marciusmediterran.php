...
<head>
    ...
    <title>Márciusban virágzó mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="marciusmediterran.php">Márciusban virágzó mediterrán növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Március' and kategoria like '%dézsás növény'";
