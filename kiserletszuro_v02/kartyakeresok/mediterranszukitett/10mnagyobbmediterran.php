...
<head>
    ...
    <title>10 m-től nagyobbra növő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="10mnagyobbmediterran.php">10 m-től nagyobbra növő mediterrán növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '10 m-től nagyobbra növő' and kategoria like '%dézsás növény'";
