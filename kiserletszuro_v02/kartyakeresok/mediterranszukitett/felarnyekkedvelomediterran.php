...
<head>
    ...
    <title>Félárnyék kedvelő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="felarnyekkedvelomediterran.php">Félárnyék kedvelő mediterrán növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'félárnyék kedvelő' and kategoria like '%dézsás növény'";
