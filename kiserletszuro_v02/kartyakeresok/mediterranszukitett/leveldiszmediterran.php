...
<head>
    ...
    <title>Mediterrán levéldísznövény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="leveldiszmediterran.php">Mediterrán levéldísznövény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%levéldísznövény' and kategoria like '%dézsás növény'";
