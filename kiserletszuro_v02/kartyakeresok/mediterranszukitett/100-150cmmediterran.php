...
<head>
    ...
    <title>100-150 cm-ig növő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="100-150cmmediterran.php">100-150 cm-ig növő mediterrán növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '100-150 cm-ig növő' and kategoria like '%dézsás növény'";
