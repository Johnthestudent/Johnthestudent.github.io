...
<head>
    ...
    <title>Kék virágú mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kekviragmediterran.php">Kék virágú mediterrán növény</a>
        </div>
    <?php
          ...
          where viragszine like '%kék' and kategoria like '%dézsás növény'";
