...
<head>
    ...
    <title>Kültéri mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kulterimediterran.php">Kültéri mediterrán növény</a>
        </div>
    <?php
          ...
          where tipus = 'Kültéri növény' and kategoria like '%dézsás növény'";
