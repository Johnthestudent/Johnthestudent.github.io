...
<head>
    ...
    <title>Narancs virágú mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="narancsviragmediterran.php">Narancs virágú mediterrán növény</a>
        </div>
    <?php
          ...
          where viragszine like '%narancs' and kategoria like '%dézsás növény'";
