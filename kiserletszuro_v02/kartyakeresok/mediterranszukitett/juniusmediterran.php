...
<head>
    ...
    <title>Júniusban virágzó mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="juniusmediterran.php">Júniusban virágzó mediterrán növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Június' and kategoria like '%dézsás növény'";
