...
<head>
    ...
    <title>Szeptemberben virágzó mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="szeptembermediterran.php">Szeptemberben virágzó mediterrán növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Szeptember' and kategoria like '%dézsás növény'";
