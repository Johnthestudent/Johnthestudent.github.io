...
<head>
    ...
    <title>Áprilisban virágzó mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="aprilismediterran.php">Áprilisban virágzó mediterrán növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Április' and kategoria like '%dézsás növény'";
