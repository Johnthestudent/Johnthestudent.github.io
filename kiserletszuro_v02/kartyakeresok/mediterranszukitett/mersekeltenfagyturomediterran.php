...
<head>
    ...
    <title>Mérsékelten fagytűrő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="mersekeltenfagyturomediterran.php">Mérsékelten fagytűrő mediterrán növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='mérsékelten fagytűrő' and kategoria like '%dézsás növény'";
