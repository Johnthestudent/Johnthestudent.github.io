...
<head>
    ...
    <title>Árnyéktűrő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="arnyekturomediterran.php">Árnyéktűrő mediterrán növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'árnyéktűrő' and kategoria like '%dézsás növény'";
