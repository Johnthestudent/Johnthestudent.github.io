...
<head>
    ...
    <title>Vörös virágú mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="vorosviragmediterran.php">Vörös virágú mediterrán növény</a>
        </div>
    <?php
          ...
          where viragszine like '%vörös' and kategoria like '%dézsás növény'";
