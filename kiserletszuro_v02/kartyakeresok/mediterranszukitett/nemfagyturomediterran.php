...
<head>
    ...
    <title>Nem fagytűrő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="nemfagyturomediterran.php">Nem fagytűrő mediterrán növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='nem fagytűrő' and kategoria like '%dézsás növény'";
