...
<head>
    ...
    <title>Törpe örökzöld mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="torpeorokzoldmediterran.php">Törpe örökzöld mediterrán növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%törpe örökzöd' and kategoria like '%dézsás növény'";
