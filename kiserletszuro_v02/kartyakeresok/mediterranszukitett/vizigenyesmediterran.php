...
<head>
    ...
    <title>Vízigényes mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="vizigenyesmediterran.php">Vízigényes mediterrán növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'vízigényes' and kategoria like '%dézsás növény'";
