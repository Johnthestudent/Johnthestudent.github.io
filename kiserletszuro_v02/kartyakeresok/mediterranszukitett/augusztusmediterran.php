...
<head>
    ...
    <title>Augusztusban virágzó mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="augusztusmediterran.php">Augusztusban virágzó mediterrán növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Augusztus' and kategoria like '%dézsás növény'";
