...
<head>
    ...
    <title>Májusban virágzó mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="majusmediterran.php">Májusban virágzó mediterrán növény</a>
        </div>
    <?php
          ...
          where viragzasideje !='' and viragzasideje like '%Május' and kategoria like '%dézsás növény'";
