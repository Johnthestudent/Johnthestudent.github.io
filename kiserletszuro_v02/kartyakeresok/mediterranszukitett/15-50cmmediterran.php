...
<head>
    ...
    <title>15-50 cm-ig növő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="15-50cmmediterran.php">15-50 cm-ig növő mediterrán növény</a>
        </div>
    <?php
          ...
          where kifejlettnovenymagassaga = '15-50 cm-ig növő' and kategoria like '%dézsás növény'";
