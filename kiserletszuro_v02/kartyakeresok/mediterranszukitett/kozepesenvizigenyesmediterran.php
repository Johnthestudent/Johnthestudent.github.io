...
<head>
    ...
    <title>Közepesen vízigényes mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="kozepesenvizigenyesmediterran.php">Közepesen vízigényes mediterrán növény</a>
        </div>
    <?php
          ...
          where vizigenye = 'közepesen vízigényes' and kategoria like '%dézsás növény'";
