...
<head>
    ...
    <title>Beltéri mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="belterimediterran.php">Beltéri mediterrán növény</a>
        </div>
    <?php
          ...
          where tipus = 'Beltéri növény' and kategoria like '%dézsás növény'";
