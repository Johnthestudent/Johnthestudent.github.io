...
<head>
    ...
    <title>Fagytűrő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fagyturomediterran.php">Fagytűrő mediterrán növény</a>
        </div>
    <?php
          ...
          where idojarasitenyezo='fagytűrő' and kategoria like '%dézsás növény'";
