...
<head>
    ...
    <title>Fehér virágú mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="feherviragmediterran.php">Fehér virágú mediterrán növény</a>
        </div>
    <?php
          ...
          where viragszine like '%fehér' and kategoria like '%dézsás növény'";
