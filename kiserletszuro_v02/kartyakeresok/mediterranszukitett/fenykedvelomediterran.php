...
<head>
    ...
    <title>Fénykedvelő mediterrán növény</title>
</head>
<body>
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="fenykedvelomediterran.php">Fénykedvelő mediterrán növény</a>
        </div>
    <?php
          ...
          where fenyigenye = 'fénykedvelő' and kategoria like '%dézsás növény'";
