...
<head>
    ...
    <title>Örökzöld mediterrán növény</title>
</head>
<body>
    <div id="filteredsections">
      <div class="card">
        <div class="card-body"><a class="card-link" href="torpeorokzoldmediterran.php">
          Törpe örökzöld
          <?php
    ...
    <!--way we are in the page-->
        <div id="utvonal">
          ...
          <a href="orokzoldmediterran.php">Örökzöld mediterrán növény</a>
        </div>
    <?php
          ...
          where novenytipusa like '%örökzöld' and kategoria like '%dézsás növény'";
